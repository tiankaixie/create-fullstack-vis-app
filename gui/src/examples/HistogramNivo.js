...
const HistogramNivo = props => {
    const { canvasHeight, data } = props;
    console.log("HistogramNivo", data);
    return (
        <ResponsiveBar
            data={data}
            ...
            borderColor={{ from: "color", modifiers: [["brighter", "2.6"]] }}
            axisTop={null}
            axisRight={null}
            axisBottom={{
                tickSize: 5,
...
export default connect(mapStateToProps, mapDispatchToProps)(HistogramNivo);
